        ...
        <div class="col-md-6">
          <form action="inc/updateSchool.php" method="POST">
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="schoolName" aria-describedby="schoolName" name="schoolName" value="'. $school['School Name'] .'">
            </div>
            <div class="mb-3">
              <label for="schoolType" class="form-label">School Type</label>
              <input type="text" class="form-control" id="schoolLevel" name="schoolLevel" value="'. $school['School Level'] .'">
            </div>
            <div class="mb-3">
            ...
            <button type="submit" name="updateSchool"class="btn btn-primary">Update School</button>
          </form>
        </div>
      </div>
    </div>
